...
Update Address_Book set Address_Book_Name='Profession_List', Address_Book_Type='Profession' where First_Name='siri'
Update Address_Book set Address_Book_Name='Friend_List', Address_Book_Type='Friend' where First_Name='shruthi'
Update Address_Book set Address_Book_Name='Family_List', Address_Book_Type='Family' where First_Name='sunny'
Update Address_Book set Address_Book_Name='Family_List', Address_Book_Type='Family' where First_Name='pooja'
Update Address_Book set Address_Book_Name='Friend_List', Address_Book_Type='Friend' where First_Name='Manisha'
